...
def main():
	...
	print "   [08] Other\n"
	print "   [10] Exit the Lazychiru\n"
	lazychiru = raw_input("lzchiru > ")
	
	if lazychiru == "1" or lazychiru == "01":
		print "\n    [01] Nmap"
		print "    [02] Red Hawk"
		print "    [03] D-Tect"
		print "    [04] sqlmap"
		...
		infogathering = raw_input("lzchiru > ")
	...
	elif lazychiru == "2" or lazychiru == "02":
		print "\n    [01] Nmap"
	...
	elif lazychiru == "3" or lazychiru == "03":
		print "\n    [01] Torshammer"
		print "    [02] Slowloris"
	...
	elif lazychiru == "4" or lazychiru == "04":
		print "\n    [01] Hydra"
	...
	elif lazychiru == "5" or lazychiru == "05":
		print "\n    [01] sqlmap"
		print "    [02] Webdav"
		print "    [03] xGans"
		...
		if webhack == "01" or webhack == "1":
			...
			timeout(2)
			restart_program()
	elif lazychiru == "6" or lazychiru == "06":
		print "\n    [01] Metasploit"
		print "    [02] commix"
		print "    [03] sqlmap"
		print "    [04] Brutal"
		...
		if exploitool == "01" or exploitool == "1":
			...
			timeout(2)
			restart_program()
	elif lazychiru == "7" or lazychiru == "07":
		print "\n    [01] KnockMail"
	...
	elif lazychiru == "8" or lazychiru == "08":
		print "\n    [01] SpiderBot"
		print "    [02] Ngrok"
		print "    [03] Sudo"
		print "    [04] Ubuntu"
